"""
Django settings for analogvibe project.
...
SECRET_KEY = 'django-insecure-ut@($l4jt*d&&zv_p4b@&n6awfc1_!kseqk*ynb_)o9tkfgi0t'
...
WSGI_APPLICATION = 'analogvibe.wsgi.application'
